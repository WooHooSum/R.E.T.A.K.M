...
Next I learned how to import other CAD models so that I could have Pi referance. Usining the Pi referance I made a standoff mount to allow the power cable to be routed under the Pi. I also had to mount the keyboards data line as it was seperate from the rest of the PCB.
